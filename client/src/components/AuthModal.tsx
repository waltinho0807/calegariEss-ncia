    ...
    return (
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="sm:max-w-[425px] bg-white border-none text-black">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={handleLogout} className="w-full border-black/10 hover:bg-black/5 hover:text-black">
              Sair da Conta
            </Button>
          </DialogFooter>
        </DialogContent>
        ...
        <form onSubmit={handleAuth} className="space-y-6 py-4">
          ...
          <div className="space-y-4">
            <Button 
              type="submit" 
              disabled={isLoading}
              className="w-full bg-black text-white hover:bg-gray-800 rounded-none uppercase tracking-widest text-xs font-bold py-6"
